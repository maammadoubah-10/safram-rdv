...
<div class="navbar">
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('medecin.disponibilite.update', $disponibilite->id) }}">
            @csrf
            @method('PUT')
            <h2>Édition de disponibilité</h2>
            <div class="form-group">
                <h5> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
                    Date de disponibilité <br>
                <input type="date" class="form-control" id="date_disponibilite" name="date_disponibilite" value="{{ old('date_disponibilite', $disponibilite->date_disponibilite) }}" required></h5>
            </div>

            <div class="form-group">
                <h5>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
                    Heure de début <br>
                <input type="time" class="form-control" id="heure_debut" name="heure_debut" value="{{ old('heure_debut', $disponibilite->heure_debut) }}" required></h5>
            </div>

            <div class="form-group">
                <h5>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
                    Heure de fin <br>
                <input type="time" class="form-control" id="heure_de_fin" name="heure_fin" value="{{ old('heure_de_fin', $disponibilite->heure_de_fin) }}" required></h5>
            </div>

            <button type="submit" class="BM">Mettre à jour</button>
        </form>
    </div>
    </div>
    </div>
