...
<div class="navbar">
    ...
    <div class="corps">
        ...
        <h2>Ajouter une Spécialité</h2><br><br><br>
        
        <form method="post" action="{{ route('admin.specialite.store') }}">
            @csrf
            <div>
                <label for="nom">Nom de la Spécialité :</label>&nbsp &nbsp &nbsp &nbsp
                <input type="text" id="nom" name="nom" placeholder="Saisissez La specialité à ajouter" required> &nbsp &nbsp
