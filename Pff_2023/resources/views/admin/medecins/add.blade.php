...
<div class="navbar">
    ...
    <form method="POST" action="{{ route('admin.medecin.store') }}" enctype="multipart/form-data">
        @csrf

        <input type="hidden" name="profil" value="Medecin">

        <!-- Champ d'envoi de l'image -->
        ...
        <!-- Prix de la visite du médecin -->
        <div class="form-group">
            <label for="prixVisite">Prix de la Visite</label>
            <input type="text" class="form-control" id="prixVisite" name="prixVisite" required>
        </div><br>
