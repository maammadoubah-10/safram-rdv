...
<body>
    ...
    <div class="navbar">
        ...
        <div class="rendezvous-container">
            @foreach ($rendezVousEnAttente as $rendezVous)
                <div class="rendezvous-item">
                <strong>Médecin : {{ $rendezVous->medecin->name }} {{ $rendezVous->medecin->lastName }}</strong> <br><br>
                    ...
                    <strong>Description :</strong> {{ $rendezVous->description }}<br><br>
                    <strong>Statut :</strong> {{ $rendezVous->statut }}<br><br>
                </div>
            @endforeach
        </div>
